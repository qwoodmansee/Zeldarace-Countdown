...
import './MM_StreamLayoutScorecard.html'
import './MM_StreamLayoutScorecard.css'

Template.MM_StreamLayoutScorecard.onCreated(function() {
    var self = this;
...
Template.MM_StreamLayoutScorecard.helpers({
...
Template.MM_StreamLayoutScorecard.onRendered(function() {
...
Template.MM_streamLayoutScorecardCollectedIconTemplate.onRendered(function() {
    $('.tooltipped').tooltip({delay: 20, position:'top'});
});
Template.MM_streamLayoutScorecardUncollectedIconTemplate.onRendered(function() {
    $('.tooltipped').tooltip({delay: 20, position:'top'});
});